...
export const findPasswordService = (FindPassword)=>{
    return request.post('/user/findPassword',FindPassword)
}

export const sendCodeService = (FindPassword)=>{
    return request.post('/utils/getCode',FindPassword)
}

export const verifyCodeService = (FindPassword)=>{
    return request.post('/utils/verifyCode',FindPassword)
}
